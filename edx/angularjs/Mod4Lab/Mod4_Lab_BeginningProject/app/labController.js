app.controller('labController', [
    ...
    function ($scope, $timeout, $q, $http, gitHub) {
        ...
        $scope.checkOddNumber = checkOddNumber;    //initialise the methods
        ...
        //if the gitHubService.js is absent
        //or function loadDetail(name) {
     ...
     //        });
        ...
        //if the gitHubSerbice.js is absent
        //function getRepos() {}
        //$http.get('https://api.github.com/orgs/angular/repos')      ---used before the gitHub service controller was added
  //       .then(function (response) {
